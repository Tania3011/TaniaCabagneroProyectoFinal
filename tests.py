...
valor_de_retorno = decidir_par_impar(4)
assert valor_de_retorno == "es par", "Prueba 1 Fallida"

valor_de_retorno = decidir_par_impar(5)
assert valor_de_retorno == "es impar", "Prueba 2 Fallida"

valor_de_retorno = decidir_par_impar(1001)
assert valor_de_retorno == "es impar", "Prueba 3 Fallida"

valor_de_retorno = decidir_par_impar(-1000)
assert valor_de_retorno == "es par", "Prueba 4 Fallida"
